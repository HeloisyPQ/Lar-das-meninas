document.addEventListener("DOMContentLoaded", () => {
    ...
    function addMarker({id, name, lat, lng}) {
        ...
        L.
        marker([lat, lng], { icon }). // Cria uma marcação na posição [Posição1, Posição2]. 
    ...
    for (const span of orphanagesSpan) {
        console.log(span)
        const orphanage = {
            id: span.dataset.id,
...
//     orphanagesSpan.map(span => {
//         console.log(span)
//         return span;
//     }).forEach( span => { // Percorre cada elemento de orphanages em termos de span.
//         const orphanage = {
//             id: span.dataset.id,
//             name: span.dataset.name,
//             lat: span.dataset.lat,
