...
L.tileLayer( // Cria o tileLayer, a primeira camada que vai recebr o mapa. 
    ...
    const popup = L.popup({
        ...
        minWidth: 240,
        minHeight: 240
    }).setContent('Lar das meninas <a href="orphanage.html?id=1 class="choose-orphanage"> <img src="./public/images/arrow-white.svg">') // Conteúdo do popup, escrever em String. 
